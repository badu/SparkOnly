		...
		private function cleanUpSource():void
		{
			...
			if (inLoadingState1)
			{
				...
				else
				{
					...
					videoPlayer.muted = beforeLoadMuted;
					/**
					 * Bogdan DINU : bug fixed, when the source is bad, this throws an exception because videoPlayer.displayObject is NULL 
					 */
					if (videoPlayer.displayObject) videoPlayer.displayObject.visible = true;
