	...
	public class FlexPrintJob
	{
								  ...
								  scaleType:String = "matchWidth"):void
		{
				...
				(fxApplicationClass && obj is fxApplicationClass))
			{
				...
				objWidth = obj.measuredWidth * obj.scaleX;
				objHeight = obj.measuredHeight * obj.scaleY;
			}
			else
			{
				...
				objWidth = obj.getExplicitOrMeasuredWidth() * obj.scaleX;
				objHeight = obj.getExplicitOrMeasuredHeight() * obj.scaleY;			
			}
