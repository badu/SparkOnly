	...
	public class PopUpManagerImpl extends EventDispatcher implements IPopUpManager
	{
												 ...
												 sbRoot:DisplayObject):void
		{
			...
			if (transparencyDuration)
			{
				...
				if (blurAmount)
				{
					...
					const blur:AnimateFilter = new AnimateFilter(o.blurTarget, new BlurFilter(blurAmount, blurAmount));
		...
		mx_internal function hideModalWindow(o:PopUpData, destroy:Boolean = false):void
		{
			...
			if (duration)
			{
				...
				if (blurAmount)
				{
					const blur:AnimateFilter = new AnimateFilter(o.blurTarget , new BlurFilter(0,0));
