	...
	public class SystemManager extends MovieClip implements IChildList, IFlexDisplayObject, IFlexModuleFactory, ISystemManager
	{
		...
		mx_internal function get densityScale():Number
		{
			...
			{    
				...
				if (isNaN(_densityScale)) _densityScale = 1;
			}
		...
		public function get rawChildren():IChildList
		{
			...
			if (!_rawChildren) _rawChildren = new SystemRawChildrenList(this);
		...
		mx_internal function initialize():void
		{
			...
			preloader.addEventListener(FlexEvent.PRELOADER_DOC_FRAME_READY, preloader_preloaderDocFrameReadyHandler);
			...
			preloader.addEventListener(Event.COMPLETE, preloader_completeHandler);
